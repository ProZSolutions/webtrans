...
use app\modules\trip\models\LpgTyreDetails;
use app\modules\trip\models\LpgTyre;

class LpgTyredetailController extends \yii\web\Controller
{
	public function behaviors() {  
	    return [
	        ...
	        'actions' => [
	          	'index'=>['get'],    
	          	'create-lpgtyre-details'=>['post'],
	          	'update-lpgtyre-details'=>['post'],
	          	'delete-lpgtyre-details'=>['post'],
	          	'view-lpgtyre-details'=>['post'],                                  
	        ],        
	      	]
	    ];
  	}  
